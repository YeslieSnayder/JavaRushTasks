...
public class Solution {
    ...
    private BlockingQueue<Integer> messageQueue = new LinkedBlockingQueue<Integer>(); // Тут будут храниться все сообщения

    private BlockingQueue<Integer> fakeDatabase = new LinkedBlockingQueue<>();
